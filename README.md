...
<p align="center">
  <a href="https://github.com/peshk0v/zapret-zen-Mac/">
...
# 🚀 [Zapret-Zen](https://github.com/peshk0v/zapret-zen)

**Zapret-Zen** - Windows-приложение для удобного управления `zapret`, `tg-ws-proxy` и встроенным `peshk0v vpn` из одного интерфейса.
...
<picture>
  ...
  <img alt="Zapret-Zen banner" src="assets/banner-dark.png">
</picture>

<div align="center">

<a href="https://github.com/peshk0v/zapret-zen/releases/latest">
...
<br><br>
<img src="https://img.shields.io/github/downloads/peshk0v/zapret-zen/total?style=for-the-badge&label=%D0%97%D0%B0%D0%B3%D1%80%D1%83%D0%B7%D0%BE%D0%BA" alt="Всего загрузок">
<img src="https://img.shields.io/github/stars/peshk0v/zapret-zen?style=for-the-badge&label=%D0%97%D0%B2%D1%91%D0%B7%D0%B4" alt="Звёзды">
<img src="https://img.shields.io/github/v/release/peshk0v/zapret-zen?style=for-the-badge&label=%D0%92%D0%B5%D1%80%D1%81%D0%B8%D1%8F" alt="Последняя версия">

</div>

<p align="center">
  <a href="https://github.com/peshk0v/zapret-zen/blob/main/donations.md#-%D0%BF%D0%BE%D0%B4%D0%B4%D0%B5%D1%80%D0%B6%D0%B0%D1%82%D1%8C-%D0%BF%D1%80%D0%BE%D0%B5%D0%BA%D1%82">
    <img src="https://img.shields.io/badge/%20Отправить%20Пожертвование-💫-6f42c1?style=for-the-badge" alt="Отправить пожертвование">
  </a>
</p>

**Автор**: peshk0v • [GitHub](https://github.com/peshk0v/zapret-zen) • [Задать вопрос](https://t.me/zzaprethub)

Что-то не работает? • [Исправить](#не-работает) • [Создать issue](https://github.com/peshk0v/zapret-zen/issues) • [Поддержка](https://t.me/zzaprethub)

</div>

## 💡 Что это такое

Zapret-Zen объединяет в одном окне:

✅ запуск и остановку `Zapret`, `TG-WS-Proxy` и `peshk0v vpn`  
...
✅ встроенный VPN-режим через подписку `vpn.peshk0v.ru` с 10-ти дневным бесплатным периодом  
...
| 🎀 **Компоненты** | Zapret, TG-WS-Proxy и peshk0v vpn управляются из одного раздела |
...
`peshk0v vpn` - встроенный VPN-режим Zapret-Zen, работающий через подписку `vpn.peshk0v.ru`.

VPN можно использовать как альтернативу Zapret. В быстром доступе есть отдельная кнопка, которая позволяет одной кнопкой переключаться между Zapret и `peshk0v vpn`. 

Возможности `peshk0v vpn`:
...
> `peshk0v vpn` не является универсальным импортом любых VPN-подписок. Компонент работает именно с подпиской `vpn.peshk0v.ru`. Таким образом я могу быть уверен в качестве соединения и работы компонента, а так же это позволяет монетизировать полностью бесплатное приложение.
...
🔹 Настроить и подключить `peshk0v vpn`  
...
> Компоненты Zapret-Zen управляются внутри приложения и не требуют запуска отдельных интерфейсов.
...
- `install_zapretzen.exe` - универсальный установщик, который установит подходящую версию
...
>
> ### Авторство
> **Zapret-Zen** = интерфейс + менеджер поверх этих инструментов.
>
...
> [!IMPORTANT]
> При разработке проектов на основе Zapret-Zen обязательно указывайте оригинального автора и авторов инструментов, перечисленных выше. Этого требует лицензия MIT.

## 📁 Структура проекта

Основные каталоги:

- `📂 src/zapret_zen` - прикладная логика, UI и сервисы
...
**Результат**: `dist\zapret_zen\`

### Установщик

```powershell
.venv\Scripts\python.exe -m PyInstaller -y packaging\install_zapretzen.spec
```

**Результат**: `dist\install_zapretzen.exe`
...
<p align="left">
  <a href="https://star-history.com/#peshk0v/zapret-zen&Date">
    <picture>
      <source
        media="(prefers-color-scheme: dark)"
        srcset="https://api.star-history.com/svg?repos=peshk0v/zapret-zen&type=Date&theme=dark"
      />
      <source
        media="(prefers-color-scheme: light)"
        srcset="https://api.star-history.com/svg?repos=peshk0v/zapret-zen&type=Date"
      />
      <img
        alt="Star History Chart"
        src="https://api.star-history.com/svg?repos=peshk0v/zapret-zen&type=Date"
      />
    </picture>
  </a>
</p>
